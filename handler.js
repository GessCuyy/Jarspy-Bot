...
import script from './plugins/info-script.js'
import { fileURLToPath } from 'url'
import path, { join } from 'path'
import { unwatchFile, watchFile } from 'fs'
import chalk from 'chalk'
import tqto from './plugins/info-tqto.js'
    ...
    try {
        ...
        for (let name in plugins) {
            ...
            if ((usedPrefix = (match[0] || '')[0])) {
                ...
                if ((name != 'plugins/owner-unbanuser.js' && name != 'plugins/ban-status.js' && name != 'plugins/owner-creator.js') && _user?.banned)
                    return
